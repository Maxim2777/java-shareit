...
class BookingDtoJsonTest {
    ...
    void setUp() {
        ...
        objectMapper.findAndRegisterModules(); // Дополнительно регистрируем модули
    ...
    void shouldFailValidationIfItemIdIsNull() {
        // Создаем объект с пустым itemId
        BookingDto bookingDto = new BookingDto();
    ...
    void shouldFailValidationIfStartIsInThePast() {
        // Создаем объект с датой начала в прошлом
        BookingDto bookingDto = new BookingDto();
        bookingDto.setItemId(10L);
    ...
    void shouldFailValidationIfEndIsNotInFuture() {
        // Создаем объект с датой окончания в прошлом
        BookingDto bookingDto = new BookingDto();
        bookingDto.setItemId(10L);
        bookingDto.setStart(LocalDateTime.now().plusDays(1));
